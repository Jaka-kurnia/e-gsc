        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div class="flex justify-end gap-2">
                <x-btn-success class="p-0! overflow-hidden shadow-sm">
                    <a href="{{ route('ibu.excel', request()->query()) }}" class="flex items-center gap-2 px-4 py-2 text-sm font-medium h-full w-full">
                ...
                <x-btn-danger class="p-0! overflow-hidden shadow-sm">
                    <a href="{{ route('ibu.pdf', request()->query()) }}" target="_blank" class="flex items-center gap-2 px-4 py-2 text-sm font-medium h-full w-full">
